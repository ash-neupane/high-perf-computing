...
#define STR(s) #s
#define PRINT_SIZE(t) printf("size of %s : %zu bytes, size of its address: %zu bytes \n", STR(t), sizeof(t), sizeof(t*))
int main() {
  ...
  printf("size of %s : %zu bytes, size of its address: %zu bytes \n", STR(student), sizeof(student), sizeof(&you));
  printf("size of %s : %zu bytes, size of its address: %zu bytes \n", STR(int [5]), sizeof(int [5]), sizeof(&x));
  return 0;
}
